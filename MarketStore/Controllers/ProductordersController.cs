...
namespace MarketStore.Controllers
{
    public class ProductordersController : Controller
    {
        ...
        {
            var modelContext = _context.Productorders.Include(p => p.Order).Include(p => p.Product);
        ...
        {
            ViewData["OrderId"] = new SelectList(_context.Order2s, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,Quntity")] Productorder productorder)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Order2s, "Id", "Id", productorder.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "ProductName", productorder.ProductId);
            return View(productorder);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,OrderId,ProductId,Quntity")] Productorder productorder)
        {
